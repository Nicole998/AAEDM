...
parser.add_argument('--loss', default = 'Rank_List_Proxy_Anchor2',
...
parser.add_argument('--evald', default = 'acc',
    ...
    if(epoch >= 0):
        ...
        with torch.no_grad():
            ...
            if args.evald == 'recallk':
                ...
                print("当前epoch:{e},Acc={acc}".format(e=epoch+1,acc=acc))
                acc_list.append(acc)
            elif args.evald == 'mae':
                mae = utils.evaluate_mae(model, dl_ev)
            else:
                f1 = utils.evaluate_f1(model, dl_ev)
